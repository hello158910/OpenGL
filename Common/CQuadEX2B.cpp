...
//	m_uiGAngleLoc = glGetUniformLocation(m_uiProgram, "fGAngle");
	m_uiTranLoc = glGetUniformLocation( m_uiProgram,  "vTranslate" );
	m_uiScaleLoc = glGetUniformLocation(m_uiProgram, "vScale");
...
//void CQuadEX2B::SetGAngle(float fGAngle)
//{
//	m_fGAngle = fGAngle;
//}
...
void CQuadEX2B::SetTranslate(float x,float y,float z)
{
	m_fTranslate[0] = x;
	m_fTranslate[1] = y;
	m_fTranslate[2] = z;
...
//void CQuadEX2B::SetScale(float vS[])
//{
//	m_fScale[0] = vS[0];
//	m_fScale[1] = vS[1];
//	m_fScale[2] = vS[2];
...
void CQuadEX2B::SetScale(float x, float y, float z)
{
	m_fScale[0] = x;
	m_fScale[1] = y;
	m_fScale[2] = z;
...
//	glUniform1f(m_uiGAngleLoc, m_fGAngle);
	glUniform3fv(m_uiTranLoc, 1, m_fTranslate);
	glUniform3fv(m_uiScaleLoc, 1, m_fScale);
